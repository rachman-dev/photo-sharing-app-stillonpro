...
const { getAllPhotos, getPhotosByCategoryId, getPhotoById, getPhotosByPublisherId, addPhoto, updatePhoto, deletePhoto, addLike, deleteLike, addComment, getComments } = require('../controllers/photoController');
